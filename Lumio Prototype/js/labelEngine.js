...
const LabelEngine = (function () {
  ...
  const EN = {
    ...
    'video.watch_link':     'Watch Video',
    // Navigation — mobile menu
    'nav.open_lessons':     'Lessons',
  ...
  const ES = {
    ...
    'video.watch_link':     'Ver vídeo',
    'nav.open_lessons':     'Lecciones',
  ...
  const FR = {
    ...
    'video.watch_link':     'Regarder la vidéo',
    'nav.open_lessons':     'Leçons',
  ...
  const DE = {
    ...
    'video.watch_link':     'Video ansehen',
    'nav.open_lessons':     'Lektionen',
